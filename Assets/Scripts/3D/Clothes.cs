...
public class Clothes : MonoBehaviour 
{
    ...
    private GameObject selectedManChest;
    
    private GameObject selectedWomanChest;
    
    private GameObject selectedManLegs;
    
    private GameObject selectedWomanLegs;
    ...
    public void previousElement( GameObject[] tabClothes, int currentElement){
        ...
        for (int i = 0; i < manLegs.Length; i++){
            ...
            if(i == currentElement){
                tabClothes[i].SetActive(true);
            }else{
                tabClothes[i].SetActive(false);
